    ...
    const handleSubmit = async (e) => {
        ...
        setForm(initialForm);
        setErrors({});
        navigate('/admin/modules/Blotter');
    };

    const handleCancel = () => {
        setForm(initialForm);
        setErrors({});
        navigate('/admin/modules/Blotter'); // Navigate back to blotter records
    };
    ...
    return (
        ...
        <div className="bg-white rounded-3xl shadow-2xl border w-full max-w-2xl p-8 relative mt-10">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
            <PlusIcon className="w-6 h-6 text-green-600" /> Add New Blotter Complaint
            </h2>
            <form className="space-y-6" onSubmit={handleSubmit} encType="multipart/form-data">
                {/* Resident Picker */}
                <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-700">Select Resident</h3>
                    <div className="flex flex-col md:flex-row gap-2 items-center">
                        <input
                            type="text"
                            placeholder="Search by name or ID..."
                            className="w-full md:w-1/2 border rounded px-4 py-2 mb-2 md:mb-0"
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-700">Complainant & Respondent</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full border rounded px-4 py-2 ${errors.complainant_name ? 'border-red-400' : ''}`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.respondent_name ? 'border-red-400' : ''}`}
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-700">Incident Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-semibold mb-1">Incident Date</label>
                            <input
                                type="date"
                                name="incident_date"
                                value={form.incident_date}
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.incident_date ? 'border-red-400' : ''}`}
                            />
                            {errors.incident_date && <p className="text-xs text-red-500 mt-1">{errors.incident_date}</p>}
                        </div>
                        <div>
                            <label className="block text-sm font-semibold mb-1">Incident Time</label>
                            <input
                                type="time"
                                name="incident_time"
                                value={form.incident_time}
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.incident_time ? 'border-red-400' : ''}`}
                            />
                            {errors.incident_time && <p className="text-xs text-red-500 mt-1">{errors.incident_time}</p>}
                        </div>
                        <div className="md:col-span-2">
                            <label className="block text-sm font-semibold mb-1">Incident Location</label>
                            <input
                                type="text"
                                name="incident_location"
                                value={form.incident_location}
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.incident_location ? 'border-red-400' : ''}`}
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-700">Complaint Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.complaint_type ? 'border-red-400' : ''}`}
                            >
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.complaint_details ? 'border-red-400' : ''}`}
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-700">Additional Information</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-semibold mb-1">Supporting Documents (optional)</label>
                            <input
                                type="file"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.contact_number ? 'border-red-400' : ''}`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={form.email}
                                onChange={handleChange}
                                className={`w-full border rounded px-4 py-2 ${errors.email ? 'border-red-400' : ''}`}
